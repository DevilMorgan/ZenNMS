...
<aside class="flex-shrink-0 flex flex-col items-center justify-between w-20 bg-white border-r border-gray-200">
  ...
  <div>
    <x-ui.atoms.aside-link href="{{ route('admin.dashboard') }}" title="Profile">
